...
<td><font face="Arial, Helvetica, sans-serif"><?php if(isset($_POST['ln'])){ echo "Date Of Maintenance"; }?></font></td>
<td><font face="Arial, Helvetica, sans-serif"><?php if(isset($_POST['ssn'])){ echo "Problem"; }?></font></td>
<td><font face="Arial, Helvetica, sans-serif"><?php if(isset($_POST['dob'])){ echo "Bill Number"; }?></font></td>
</tr>
